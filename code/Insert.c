...
void Insert(REGISTER registerData)
{
    ...
    char removedMarker = '*';
     ...
     fwrite(&divider, 1, sizeof(divider), resultFile);
     fwrite(&registerData.ClientName, 1, sizeof(registerData.ClientName), resultFile);
     fwrite(&divider, 1, sizeof(divider), resultFile);
     fwrite(&registerData.MovieName, 1, sizeof(registerData.MovieName), resultFile);
     fwrite(&divider, 1, sizeof(divider), resultFile);
     fwrite(&registerData.Genre, 1, sizeof(registerData.Genre), resultFile);
     fwrite(&divider, 1, sizeof(divider), resultFile);
